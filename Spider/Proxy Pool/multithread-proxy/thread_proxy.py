...
def test_useful(proxy):
    ...
    try:
        ...
        data = {'page': 5, 'cityPY': 'shanghai', 'cityId': 2, 'cityCode': '021'}
        requests.post('https://hotels.ctrip.com/Domestic/Tool/AjaxHotelList.aspx', data=data,
    ...
    while opt <= 1:
        ...
        while page < max_page:
            ...
            driver = webdriver.PhantomJS(
                executable_path=r"D:\Programs\phantomjs-2.1.1-windows\bin\phantomjs")
            #driver = webdriver.PhantomJS(executable_path=r'D:\phantomjs-2.1.1-windows\bin\phantomjs.exe')
            driver.get(url)
            print('Sleep 0.7 sec... page ',page)
            time.sleep(0.7)
